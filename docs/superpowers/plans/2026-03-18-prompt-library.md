...
**Goal:** Implement a Prompt Library feature to store and organize reusable prompts with title, prompt text, and category.

**Architecture:** MongoDB-backed feature with REST API endpoints, lazy-loaded React component, following existing patterns in the Owen Zen platform.

**Tech Stack:** React, TypeScript, MongoDB/Mongoose, Tailwind CSS, Framer Motion
...
| File | Purpose |
|------|---------|
| `src/models/Prompt.ts` | NEW - Mongoose schema |
| `src/app/api/prompts/route.ts` | NEW - GET, POST endpoints |
| `src/app/api/prompts/[id]/route.ts` | NEW - PUT, DELETE endpoints |
| `src/components/PromptLibraryView.tsx` | NEW - Main view component |
| `src/app/page.tsx` | Modify - Add sidebar link |

---

## Task 1: Create Prompt Model

**Files:**
- Create: `src/models/Prompt.ts`
...
## Task 2: Create API Route (GET/POST)

**Files:**
- Create: `src/app/api/prompts/route.ts`

- [ ] **Step 1: Create prompts API route**
...
## Task 3: Create API Route (PUT/DELETE)

**Files:**
- Create: `src/app/api/prompts/[id]/route.ts`

- [ ] **Step 1: Create prompts/[id] API route**
...
## Task 4: Create PromptLibraryView Component

**Files:**
- Create: `src/components/PromptLibraryView.tsx`

- [ ] **Step 1: Create PromptLibraryView component**
...
- [ ] **Step 2: Add Prompt Library to Tools section**

Find the Tools section links (around line 229) and add:
```typescript
...
Find the lazy imports section (around line 100) and add:
```typescript
...
- [ ] **Step 4: Add to activeTab render**
...
| Task | Description |
|------|-------------|
| 1 | Create Prompt model (MongoDB) |
| 2 | Create GET/POST API routes |
| 3 | Create PUT/DELETE API routes |
| 4 | Create PromptLibraryView component |
| 5 | Add sidebar link and routing |

## Dependencies

- Task 1 must complete before Tasks 2, 3
- Task 4 requires Tasks 2, 3 to be complete
- Task 5 requires Task 4 to be complete

## Testing

- Test API endpoints with curl or Postman
- Test UI: add, edit, delete, filter, search prompts
- Verify sidebar link navigates to Prompt Library
