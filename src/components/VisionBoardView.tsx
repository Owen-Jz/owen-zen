...
const MOODBOARD = [
  "https://i.pinimg.com/236x/25/a7/5e/25a75e8a80ed8c28d853216a662cdda5.jpg", // Physique
  "https://i.pinimg.com/236x/2b/e4/23/2be423633a1409f8aa6fba8b697cdd13.jpg", // Lambo/Luxury
    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold flex items-center gap-3">
            <span className="text-4xl">🦅</span> Vision & Word
        </h1>
        <p className="text-gray-500 hidden md:block">Fuel for the spirit and mind.</p>
      </div>
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                          <p className="text-white text-sm font-medium tracking-wide">
                              {i === 0 ? "Physique Goal" : 
                               ...
                               i === 2 ? "The Environment" : 
                               i === 3 ? "The Team" : 
                               i === 4 ? "The Foundation" : "The Giveback"}
                          </p>
                      </div>
                  </motion.div>
              ))}
