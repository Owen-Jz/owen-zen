    ...
    >
      ...
      <div className="flex items-start gap-4">
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-2xl font-bold font-mono" style={{ color: "var(--cc-text)" }}>
            {mitCount}
          </span>
        ...
        {overdueCount > 0 && (
          <div className="flex flex-col items-center gap-1">
            ...
            <span className="text-2xl font-bold font-mono" style={{ color: "var(--cc-warning)" }}>
              {overdueCount}
            </span>
            <span className="text-[10px] uppercase" style={{ color: "var(--cc-warning)" }}>
              overdue
            </span>
          </div>
        )}
