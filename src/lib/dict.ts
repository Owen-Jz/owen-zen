// AI Prompting Dictionary — data layer and pure logic functions
// Shared between the dictionary page and its unit tests.
...
/**
 * Filter terms by search query and/or category.
 */
 ...
 * Returns null when a specific category is active (flattened view is shown instead).
 */
export function groupTermsByCategory(
  terms: Term[],
  activeCategory: Category | 'All'
): Partial<Record<Category, Term[]>> | null {
